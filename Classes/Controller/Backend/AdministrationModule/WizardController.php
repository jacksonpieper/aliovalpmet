...
class WizardController extends AbstractModuleController implements Configurable
{
    ...
    private function selectTemplate(Response $response)
    {
        ...
        $view = $this->initializeView('Backend/AdministationModule/WizardController/SelectTemplate');
    ...
    private function enterDefaultValues(Response $response)
    {
        ...
        $view = $this->initializeView('Backend/AdministationModule/WizardController/EnterDefaultValues');
...
//            $import->display_import_pid_record = $this->pageinfo;
        ...
        $view = $this->initializeView('Backend/AdministationModule/WizardController/Map');
