...
/**
 * Class Extension\Templavoila\Controller\Backend\PageModule\Renderer\Sidebar\VersioningTab
 */
class VersioningTab implements Renderable
{
    ...
    public function render()
    {
        if ($this->controller->getId() > 0) {
            $versionSelector = trim((string)$this->controller->doc->getVersionSelector($this->controller->getId()));
            if (!$versionSelector) {
